<template>
        <div  class="w-4/6 mx-auto countdown bg-dark flex flex-col sm:flex-row md:flex-row lg:flex-row justify-center items-center">
            ...
            <!-- countdown -->
            <h1 class=" sm:border-solid md:border-solid lg:border-solid sm:border-blue-grey md:border-blue-grey lg:border-blue-grey sm:border-l-6 md:border-l-6 lg:border-l-6 py-2 px-2 sm:pl-10 md:pl-l0 lg:pl-10text-dark-blue text-center sm:text-left md:text-left lg:text-left">{{ message }} </h1>
